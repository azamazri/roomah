-- ============================================================================
-- MIGRATION 14: Admin Tables (No Foreign Keys - Data Integrity at App Layer)
-- ============================================================================
...
-- ============================================================================
-- Note: Foreign keys not used due to type mismatches in existing schema
-- Data integrity enforced at application layer via server actions
-- All tables have proper indexes and triggers for performance & audit trail
