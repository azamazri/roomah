-- =====================================================
-- Migration: Fix Avatar Path in Approved Candidates View
-- Description: Perbaiki field avatar_path dari p.avatar_url menjadi p.avatar_path
-- Date: 2025-10-28
-- =====================================================

-- Drop dan recreate materialized view dengan field avatar yang benar
...
COMMENT ON MATERIALIZED VIEW public.approved_candidates_v IS 
  'Materialized view untuk approved candidates dengan avatar_path yang benar dari cv_data atau profiles';
